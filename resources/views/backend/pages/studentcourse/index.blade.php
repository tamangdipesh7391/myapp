...
<div class="col-md-12">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a href="{{url('admin/edit-student-course/'.$data->id)}}"class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>

                <a href="{{url('admin/delete-student-course/'.$data->id)}}" onclick="return confirm('Are you sure you want to delete this?')"class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
